...
$route['admin/menus'] = 'Admin/Admin/menus';
$route['admin/menusorting'] = 'Admin/Admin/menusorting';
$route['admin/permissions/(:any)'] = 'Admin/Admin/permissions/$1';
$route['admin/permissions'] = 'Admin/Admin/permissions';
